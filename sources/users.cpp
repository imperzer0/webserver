...
const auto* get_registered_users()
{
...
/// Forward all registered users onto ftp server instance
...
/// Add a user to ftp server instance
...
void add_pending_user(id_t id, const __user_map_t::value_type& user)
{
    registered_users_pending.insert({id, user});
}
